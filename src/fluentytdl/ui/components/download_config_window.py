...
class DownloadConfigWindow(FramelessWindow):
    ...
    def __init__(self, url: str, parent=None, *, vr_mode: bool = False, mode: str = "default", smart_detect: bool = False):
        ...
        self.selector_widget: VideoFormatSelectorWidget | VRFormatSelectorWidget | SubtitleSelectorWidget | CoverSelectorWidget | None = None
    ...
    def _check_is_vr_content(self, info: dict[str, Any]) -> bool:
        ...
        keywords = ("360 video", "360 movie", "vr 360", "360°", "vr180", "180 vr", "3d 180", "3d 360")
    ...
    def _auto_apply_row_preset(self, row: int) -> None:
        ...
        if self._vr_mode:
            ...
            # 显示详细信息（包含音频信息）
            v_line = _format_info_line("视频 ", best.get("filesize") or best.get("filesize_approx"), best.get("ext"))
            a_line = ""
            if chosen_audio:
                a_line = "\n" + _format_info_line("音频 ", chosen_audio.get("filesize") or chosen_audio.get("filesize_approx"), chosen_audio.get("ext"))
        ...
        for _i, row_data in enumerate(self._playlist_rows):
            ...
            if self._vr_mode:
                ...
                if row_data.get("detail"):
                    row_opts["__android_vr_format_ids"] = row_data["detail"].get("__android_vr_format_ids", [])
